...
import typing
__all__ = ['A', 'E2', 'F', 'GE', 'GP', 'RATE', 'curvature_matrix', 'gravitation_ecef', 'gravity', 'gravity_n', 'principal_radii', 'rate_n', 'say_hello']
def curvature_matrix(lat: float, alt: float) -> numpy.ndarray[numpy.float64[3, 3]]:
    """
    Computes the Earth curvature matrix.
    """
def gravitation_ecef(lla: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> numpy.ndarray[numpy.float64[3, 1]]:
    """
